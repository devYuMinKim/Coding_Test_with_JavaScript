// 제로베이스 프론트엔드 스쿨_ControlBallNumber
/*
[문제 설명]
...
function solution(array) {
  ...
  for (let i = 1; i <= 100; i++) {
    ...
    if (arr.length === length && arr[arr.length - 1] === last) {
      answer.push("End");
      break;
    }
  }
...
console.log(solution([1, 3, 4])); // output: ["In", "In", "Out", "In", "In", "End"]
