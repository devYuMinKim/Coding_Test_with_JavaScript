...
A 실행(요청으로 부터 3초 소요)
B 실행(1초에서 3초까지 대기한 후 작업을 시작해서 7초 소요)
C 실행(3초에서 8초까지 대기한 후 작업을 시작해서 15초 소요)
평균 8.33초

방법 2

A 실행(요청으로 부터 3초 소요)
C 실행(3초에 작업 시작해서 10초 소요)
B 실행(1초에서 14초까지 대기한 후 작업 시작해서 17초 소요)
평균 10초
